...
<head>
    ...
    <title>Login | Pial Mahmud AI Assistant</title>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .alert-success {
            background: rgba(78, 209, 178, 0.1);
            border-color: rgba(78, 209, 178, 0.3);
            color: #4ed1b2;
        }
    </style>
</head>
    ...
    <div class="auth-container">
        <div class="auth-card">
            <div class="brand-section">
                ...
                <p class="brand-subtitle">Powered by Gemini API</p>
            </div>
            ...
            <form action="{{ route('auth.login') }}" method="POST">
                ...
                <div class="form-group">
                    <label style="display: flex; align-items: center; gap: 8px; margin-bottom: 0; font-weight: 400;">
